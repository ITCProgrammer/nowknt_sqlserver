...
?>
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
			...
			<table id="lookup30" class="table table-sm table-bordered table-hover table-striped" width="100%" style="font-size: 14px;">
						<thead>
							<tr>
							  <th>#</th>
...
WHERE
	a.ITEMTYPECODE = 'GYR'
	AND a.LOGICALWAREHOUSECODE = 'M011'
	AND
...
<script>
  $(function () {
    ...
    }).buttons().container().appendTo('#lookup30_wrapper .col-md-6:eq(0)');		 
  });
</script>
