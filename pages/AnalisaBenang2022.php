...
<!-- Main content -->
      <div class="container-fluid">
		...
		<div class="card card-success">
          ...
          <?php
		  $sqlDB21 =" SELECT *,CURRENT_TIMESTAMP AS TGLS FROM ITXVIEWKNTORDER WHERE ITEMTYPEAFICODE ='KGF' AND PROJECTCODE ='$Project' AND SUBCODE02='$subC1' AND SUBCODE03='$subC2' AND (PROGRESSSTATUS='2' OR PROGRESSSTATUS='6') ";	
