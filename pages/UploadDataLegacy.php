<!-- Main content -->
      <div class="container-fluid">
		<div class="alert alert-success alert-dismissible">
                  ...
                  Upload Data Stock Benang Knitting
		</div>  
...
if (isset($_POST['submit']))
{
    ...
    if (!empty($_FILES['file']['name']) && in_array($_FILES['file']['type'], $fileMimes))
    {
            ...
            while (($getData = fgetcsv($csvFile, 100000, ",")) !== FALSE)
            {
                ...
                mysqli_query($con, "INSERT INTO tbl_stokfull (tgl_buat, kd, SN, KG, cones, lot, zone, lokasi, id_upload) 
				VALUES ('" . $tgl_buat . "', '" . $kd . "', '" . $SN . "', '" . $kg . "', '" . $cones . "', '" . $lot . "', '" . $zone . "', '" . $lokasi ."', '" . $idUp . "')"); 
