...
$sqlCek3=mysqli_query($con,"SELECT id_upload FROM tbl_stokfull WHERE zone='$Zone' AND lokasi='$Lokasi'");
$ck3=mysqli_fetch_array($sqlCek3);
...
if($_POST['cek']=="Cek" or $_POST['cari']=="Cari"){
	...
	BALANCE b WHERE (b.ITEMTYPECODE='GYR' OR b.ITEMTYPECODE='DYR') AND (b.LOGICALWAREHOUSECODE='P501' OR b.LOGICALWAREHOUSECODE='M904') AND b.ELEMENTSCODE='$Barcode' ";
...
<!-- Main content -->
		...
		<div class="card card-default">
          ...
          <div class="card-body">
             <div class="form-group row">
               ...
               <input type="text" class="form-control"  name="barcode" placeholder="SN / Elements" id="barcode" on autofocus autocomplete="off">			    
            </div>	
		  ...
		  <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
				 <strong>Stok OK Sesuai Tempat</strong> <small class='badge badge-success'> <?php echo $ck1['jml'];?> dus</small><br>
				 <strong>Stok belum Cek</strong> <small class='badge badge-danger'> <?php echo $ck2['jml'];?> dus </small> 
   ...
   $c=0;
	...
	$lokasiBalance=trim($rowdb22['WHSLOCATIONWAREHOUSEZONECODE'])."-".trim($rowdb22['WAREHOUSELOCATIONCODE']);
      ...
      <td style="text-align: center"><?php echo $rowd['cones']; ?></td>
      <td style="text-align: center"><?php echo $rowd['kd']; ?></td>
