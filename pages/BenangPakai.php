      ...
      <div class="container-fluid">
		...
		<div class="card card-success">
          <div class="card-header">
            <h3 class="card-title">Filter Data Tgl Benang Pakai</h3>
		...
		<div class="card card-warning">
              <div class="card-header">
				...
				<a href="pages/cetak/cetaklapbenangkeluar.php?awal=<?php echo $Awal;?>&akhir=<?php echo $Akhir;?>&shift=<?php echo $Shift;?>" class="btn bg-blue float-right" target="_blank">to Print</a>   
          </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-sm table-bordered table-striped" style="font-size: 13px; text-align: center;">
                  ...
                  <tr>
                    ...
                    <th valign="middle" style="text-align: center">No Art</th>
                    ...
                    <th valign="middle" style="text-align: center">Kode Point</th>
                    </tr>
                  </thead>
                  <tbody>
				  <?php
...
?>
      ...
      <td style="text-align: center"><?php if($rowdb22PRO['PROJECTCODE']!=""){echo $rowdb22PRO['PROJECTCODE'];}else{echo $rowdb22PRO['ORIGDLVSALORDLINESALORDERCODE'];} ?></td>
      <td style="text-align: center"><?php echo trim($rowdb22PRO['SUBCODE02'])."".$rowdb22PRO['SUBCODE03']." ".$rowdb22PRO['SUBCODE04']; ?></td>
      <td style="text-align: center"><a href="#" id="<?php echo trim($rowdb21['TRANSACTIONNUMBER'])."#".trim($rowdb21['ORDERCODE'])."#".trim($rowdb21['TRANSACTIONDATE'])."#".trim($rowdb21['CREATIONUSER'])."#".trim($rowdb21['LOTCODE'])."#".trim($kdbenang); ?>" class="show_detailPakai"><?php echo $rowdb21['ORDERCODE']; ?></a></td>
      ...
      <td style="text-align: center"><?php echo $rowdb21['WHSLOCATIONWAREHOUSEZONECODE']."-".$rowdb21['WAREHOUSELOCATIONCODE']; ?></td>
      <td><?php  echo $msin; ?></td>
      <td><?php  echo $rk['no_mesin']; ?></td>
      <td><?php echo $rKPI['VALUESTRING']; ?></td>
      </tr>	  				  
	<?php 
	 $no++; 
