...
//}	
	...
	if($rowdb2['BASEPRIMARYQUANTITY']>0){
	  ...
	  <td style="text-align: right"><?php if(substr($rowdb2['PROJECTCODE'],0,3)=="OPN" or substr($rowdb2['ORIGDLVSALORDLINESALORDERCODE'],0,3)=="OPN"){echo "<a href='#' class='show_detail_allokasi' id='" . $proj ."-". $hanger ."-". $rowdb2['PRODUCTIONDEMANDCODE'] . "'>".round($rKBG['tot'],2) - round($rowdb2R['JQTY'], 2)."</a>";}else{echo "<a href='#' class='show_detail_allokasi' id='" . $proj ."-". $hanger ."-". $rowdb2['PRODUCTIONDEMANDCODE'] . "'>".(round(($rowdb2['BASEPRIMARYQUANTITY']+$rowdb2['QTYOPOUT'])-($rowdb2['QTYSALIN']+$rowdb2['QTYOPIN']),2))-round($rowdb2['JQTY_J2'],2)."</a>";}?></td>
