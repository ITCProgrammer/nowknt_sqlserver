...
if(trim($rowdb29['STS'])=="HOLD"){ $OC="HOLD";}
else if(trim($rowdb29['STS'])=="HABIS BENANG"){ $OC="PBS";}
else if(trim($rowdb29['STS'])=="TUNGGU BENANG GUDANG"){ $OC="PBG";}
else if(trim($rowdb29['STS'])=="ANTRI MESIN"){ $OC="AMC";}
else if(trim($rowdb29['STS'])=="TUNGGU PASANG BENANG"){ $OC="TPB";}
else if(trim($rowdb29['STS'])=="Tunggu Setting"){ $OC="TST";}
else if(trim($rowdb29['STS'])=="TUNGGU TES QUALITY"){ $OC="TTQ";}
else { $OC=""; }	
if($OC!=""){	
