...
$c=0;
	...
	SUM(BASESECONDARYQUANTITYUNIT) AS QTY_CONES,WHSLOCATIONWAREHOUSEZONECODE,WAREHOUSELOCATIONCODE,LOGICALWAREHOUSECODE,ELEMENTSCODE 
		FROM DB2ADMIN.BALANCE BALANCE  
		WHERE (BALANCE.LOGICALWAREHOUSECODE='P501' OR BALANCE.LOGICALWAREHOUSECODE='M904') AND BALANCE.ITEMTYPECODE='GYR'
		GROUP BY ELEMENTSCODE,WHSLOCATIONWAREHOUSEZONECODE,WAREHOUSELOCATIONCODE,LOGICALWAREHOUSECODE
		"; 
