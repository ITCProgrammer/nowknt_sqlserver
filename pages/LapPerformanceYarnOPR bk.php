...
i.PRODUCTIONORDERCODE,i.SCHEDULEDRESOURCECODE  
FROM ITXVIEWKNTORDER i 
GROUP BY i.PRODUCTIONORDERCODE,i.SCHEDULEDRESOURCECODE
...
?>
      ...
      <td style="text-align: center"><?php echo $stmtQ2['CONES']; ?></td>
      <td style="text-align: center">&nbsp;</td>
      <td style="text-align: center"><?php echo (KPI("KBC","DUS")*$rowdb21['KBC_DUS'])+(KPI("KBP","DUS")*$rowdb21['KBP_DUS'])+((KPI("KBPC","DUS")*$rowdb21['KBPC_DUS'])+round((KPI("KBPC","CONES")*$rowdb21['KBPC_CONES'])/60))+((KPI("KBPP","DUS")*$rowdb21['KBPP_DUS'])+round((KPI("KBPP","CONES")*$rowdb21['KBPP_CONES'])/60))+((KPI("TB","DUS")*$rowdb21['TB_DUS'])+round(($rowdb21['TB_KG'])/(KPI("TB","CONES")))+(KPI("TBT","DUS") * $dTBT)+(KPI("PBT","DUS") * $dPBT)); ?></td>
      <td style="text-align: center"><?php echo round(((KPI("KBC","DUS")*$rowdb21['KBC_DUS'])+(KPI("KBP","DUS")*$rowdb21['KBP_DUS'])+((KPI("KBPC","DUS")*$rowdb21['KBPC_DUS'])+round((KPI("KBPC","CONES")*$rowdb21['KBPC_CONES'])/60))+((KPI("KBPP","DUS")*$rowdb21['KBPP_DUS'])+round((KPI("KBPP","CONES")*$rowdb21['KBPP_CONES'])/60))+((KPI("TB","DUS")*$rowdb21['TB_DUS'])+round(($rowdb21['TB_KG'])/(KPI("TB","CONES")))+(KPI("TBT","DUS") * $dTBT)+(KPI("PBT","DUS") * $dPBT)))/420,2)*100;?></td>
      </tr>	  				  
	<?php 
	 $no++; 
