      ...
      <div class="container-fluid">
		...
		<div class="card card-success">
          <div class="card-header">
            <h3 class="card-title">Filter Data Tgl Benang Turunan</h3>
		...
		<div class="card card-warning">
              <div class="card-header">
                <h3 class="card-title">Detail Data Benang Turunan</h3>
				<a href="pages/cetak/cetaklapmasukbenangturunan.php?awal=<?php echo $Awal;?>&akhir=<?php echo $Akhir;?>&shift=<?php echo $Shift;?>" class="btn bg-blue float-right" target="_blank">to Print</a>  
          </div>
              <!-- /.card-header -->
              <div class="card-body">
...
?>
      ...
      <td><?php echo $rEXPD['VALUEDATE']; ?></td>
      </tr>
