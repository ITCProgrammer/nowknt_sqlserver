...
$sqlDB22PRO =" SELECT ITXVIEWKK.PROJECTCODE,ITXVIEWKK.ORIGDLVSALORDLINESALORDERCODE FROM 
 PRODUCTIONORDER  
...
?>
      ...
      <td style="text-align: center"><a href="#" id="<?php echo trim($rowdb21['ORDERCODE'])."#".trim($rowdb21['TRANSACTIONDATE'])."#".trim($rowdb21['CREATIONUSER'])."#".trim($rowdb21['LOTCODE'])."#".trim($kdbenang); ?>" class="show_detailPakai"><?php echo $rowdb21['ORDERCODE']; ?></a></td>
