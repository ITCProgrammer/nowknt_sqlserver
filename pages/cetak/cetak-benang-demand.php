...
header("Content-Disposition: attachment; filename=laporan loss benang PO " . $status . ".xls");
    ...
    <div class="card card-warning">
        <div class="card-body">
            <table id="example1" class="table table-sm table-bordered table-striped"
                ...
                <thead>
                    <tr>
                        <th colspan="20" style="border: 1px solid black; font-size: 2em;">
...
i.LEGALNAME1,i.SUBCODE01,i.SUBCODE02,i.SUBCODE03,i.SUBCODE04,i.PROJECTCODE,i.SCHEDULEDRESOURCECODE,VARCHAR_FORMAT(i.FINALEFFECTIVEDATE,'YYYY-MM-DD') AS TGLSELESAI,
...
i.LEGALNAME1,i.SUBCODE01,i.SUBCODE02,i.SUBCODE03,i.SUBCODE04,i.PROJECTCODE,i.SCHEDULEDRESOURCECODE,i.PRODUCTIONORDERCODE ";
	...
	";
	 ...
	 WHERE tidn.demandno='$rowdb2[PRODUCTIONDEMANDCODE]' and tidn.ket_bs ='BS Lain-lain'");
                        ...
                        <tr>
                            ...
                            <td style="border: 1px solid black; padding: 0.5em;">
                                <?php
                                if ($rowdb2['SCHEDULEDRESOURCECODE'] != "") {
                                    echo $rowdb2['SCHEDULEDRESOURCECODE'];
                                } else {
