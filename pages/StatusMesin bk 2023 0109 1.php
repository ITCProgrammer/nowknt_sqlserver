...
USERGENERICGROUP.SHORTDESCRIPTION,USERGENERICGROUP.SEARCHDESCRIPTION,DMN.* FROM DB2ADMIN.USERGENERICGROUP 
LEFT JOIN
(
...
WHERE ITXVIEWKNTORDER.ITEMTYPEAFICODE ='KGF' AND ITXVIEWKNTORDER.PROGRESSSTATUS='2' 
 ORDER BY ITXVIEWKNTORDER.INITIALSCHEDULEDACTUALDATE,AD1.VALUEDATE ASC
) DMN ON (DMN.VALUESTRING=USERGENERICGROUP.CODE OR DMN.SCHEDULEDRESOURCECODE=USERGENERICGROUP.CODE) 
...
VIEWPRODDEMANDELEMENTS WHERE DEMANDCODE ='$rowdb2[PRODUCTIONDEMANDCODE]' AND PROGRESSSTATUS='0' AND COMPANYCODE='100' ";	
...
WHERE PRODUCTIONDEMANDCODE ='$rowdb2[PRODUCTIONDEMANDCODE]' AND (OPERATIONCODE='INS1' OR OPERATIONCODE='KNT1') AND ITEMTYPEAFICOMPANYCODE ='100'
