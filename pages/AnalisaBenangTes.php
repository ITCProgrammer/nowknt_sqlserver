...
<!-- Main content -->
      <div class="container-fluid">
		...
		<div class="card card-success">
          ...
          <?php
		  $sqlDB21 =" SELECT SUBCODE02,SUBCODE03, SUM(BASEPRIMARYQUANTITY) AS BASEPRIMARYQUANTITY,CURRENT_TIMESTAMP AS TGLS FROM ITXVIEWKNTORDER 
		  WHERE ITEMTYPEAFICODE ='KGF' AND PROJECTCODE ='$Project' AND SUBCODE02='$subC1' AND SUBCODE03='$subC2' AND SUBCODE04='$subC3' AND (PROGRESSSTATUS='2' OR PROGRESSSTATUS='6') 
		  GROUP BY SUBCODE02,SUBCODE03,CURRENT_TIMESTAMP ";	
...
<table id="example1" class="table table-sm table-bordered table-striped" style="font-size:13px;">
        <thead>
                  ...
                  <tr>
                    ...
                    <th style="text-align: center">M904</th>
                    <th style="text-align: center">P501</th>
                    <th style="text-align: center">M904</th>
...
BNG.SUBCODE05,BNG.SUBCODE06,BNG.SUBCODE07,BNG.SUBCODE08,BNG.QUANTITYPER FROM ITXVIEWKNTORDER 
LEFT OUTER JOIN (
...
PRODUCTIONRESERVATION.RELATEDCMPBILLOFMATSUBCODE04='$subC3'
ORDER BY BOMCOMPSEQUENCE ASC
) BNG ON BNG.PRODUCTIONORDERCODE=ITXVIEWKNTORDER.PRODUCTIONORDERCODE 
WHERE ITXVIEWKNTORDER.ITEMTYPEAFICODE ='KGF' AND ITXVIEWKNTORDER.PROJECTCODE ='$Project' AND 
ITXVIEWKNTORDER.SUBCODE02='$subC1' AND ITXVIEWKNTORDER.SUBCODE03='$subC2' AND ITXVIEWKNTORDER.SUBCODE04='$subC3' AND
(ITXVIEWKNTORDER.PROGRESSSTATUS='2' OR ITXVIEWKNTORDER.PROGRESSSTATUS='6') 
GROUP BY BNG.BOMCOMPSEQUENCE,BNG.SUBCODE01,BNG.SUBCODE02,BNG.SUBCODE03,BNG.SUBCODE04,
BNG.SUBCODE05,BNG.SUBCODE06,BNG.SUBCODE07,BNG.SUBCODE08,BNG.QUANTITYPER
...
il.INTERNALREFERENCE ='$HangerNO' AND
...
DECOSUBCODE08='$rowdb22[SUBCODE08]'
	...
	$rdb22 = db2_fetch_assoc($st12);	 
      ...
      <td style="text-align: center"><a href="#" id="" class="btn btn-xs btn-info show_detail" alt="Detail"><i class="far fa-eye" aria-hidden="true"></i> </a> </td>
      <td style="text-align: right"><?php echo number_format(round($rowdb23['RECEIVEDBASEPRIMARYQUANTITY'],2),2); ?> Kgs</td>
      <td style="text-align: right"><?php echo number_format(round($rowdb23['P501'],2),2); ?> Kgs</td>
      <td style="text-align: right"><?php echo number_format(round($rowdb23['M904'],2),2); ?> Kgs</td>
